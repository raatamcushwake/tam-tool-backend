...
from app.routes.CostReviewService import router as cost_review_router
...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:5173",
        "http://127.0.0.1:5173",
        "https://tam-cushman-wakefield.onrender.com",
    ],
...
app.include_router(cost_review_router, prefix="/api/tdd/cost-review", tags=["TDD Cost Review"])
